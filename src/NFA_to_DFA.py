...
class DFA:
    ...
    def __init__(self, initial_State: DFA_State, accept_states: set[DFA_Accept_State], alphabet: set,
                 Q: set[DFA_State | DFA_Accept_State | DFA_Trap_State]):
    ...
    while frozen_queue:
        ...
        for symbol in nfa.alphabet:
            ...
            if flag == "accept":
                ...
                target_DFA_state = universal_trap_state
            else:
